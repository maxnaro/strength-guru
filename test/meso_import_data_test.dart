          ...
          ImportDay(
            ...
            exercises: [
              ImportExercise(
                ...
                muscleGroup: 'chest',
                weekTargets: [
                  const ImportWeekTarget(weekIdx: 0, reps: [8, 8, 8], rir: [2, 2, 2]),
                  const ImportWeekTarget(weekIdx: 1, reps: [8, 8, 8], rir: [1, 1, 1]),
                  const ImportWeekTarget(weekIdx: 2, reps: [8, 8, 8], rir: [1, 1, 1]),
                ],
              ),
            ],
          ),
